...
struct AdditionMode: View {
    var gameMode: GameModes = .addition
    @Environment(\.dismiss) var dismiss
    
    @State private var userChoice = 0
    
    @State private var numberOne = Int.random(in: 1...100)
    @State private var numberTwo = Int.random(in: 1...100)
    ...
    var body: some View {
        NavigationStack {
            VStack(alignment: .center) {
                ...
                Text("What is \(numberOne) + \(numberTwo)?")
                    .font(.title)
            ...
            .alert(alertTitle, isPresented: $alertPresented) {
                ...
                Text("The answer was \(numberOne + numberTwo)")
            }
            .onSubmit {
                gameLogic()
                gameOver()
    ...
    func gameLogic() {
        ...
        if userChoice == (numberOne + numberTwo) {
            score += 1
            alertTitle = "Correct!"
        } else {
